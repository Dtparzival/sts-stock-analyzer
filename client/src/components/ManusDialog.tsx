...
export function ManusDialog({
  ...
  return (
    ...
    >
      <DialogContent className="py-5 bg-surface rounded-[20px] w-[400px] shadow-md border border-border/50 backdrop-blur-2xl p-0 gap-0 text-center">
        <div className="flex flex-col items-center gap-2 p-5 pt-12">
          <div className="w-16 h-16 bg-background rounded-xl border border-border/50 flex items-center justify-center">
